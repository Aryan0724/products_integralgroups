...
const floatingProducts = [
  { name: "AlgoPilot", Icon: Sparkles, x: "15%", y: "25%", size: "w-20 h-20", delay: 0 },
  { name: "IntegralHQ", Icon: Layers, x: "80%", y: "30%", size: "w-24 h-24", delay: 1 },
  { name: "ExamPlanner", Icon: TrendingUp, x: "10%", y: "65%", size: "w-18 h-18", delay: 2 },
  { name: "AI Analytics", Icon: Cpu, x: "90%", y: "60%", size: "w-16 h-16", delay: 0.5 },
  { name: "Automation", Icon: Zap, x: "25%", y: "80%", size: "w-14 h-14", delay: 1.5 },
  { name: "Infrastructure", Icon: Database, x: "75%", y: "85%", size: "w-12 h-12", delay: 0.8 },
  { name: "Edge Systems", Icon: Terminal, x: "5%", y: "40%", size: "w-16 h-16", delay: 2.2 },
  { name: "Product Engineering", Icon: Globe, x: "95%", y: "35%", size: "w-14 h-14", delay: 1.2 },
];
...
export function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen bg-[#050505] overflow-hidden flex flex-col items-center"
    >
      {/* Background System */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 grid-pattern opacity-[0.03] animate-pulse-slow" />
        <div className="absolute inset-0 bg-gradient-to-b from-[#050505] via-transparent to-[#050505]" />
        
        {/* Advanced Background Lighting */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[1000px] bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.05)_0%,transparent_70%)]" />
          <div className="absolute top-[20%] left-[10%] w-[500px] h-[500px] bg-blue-600/5 blur-[120px] rounded-full animate-pulse-slow" />
          <div className="absolute top-[40%] right-[10%] w-[600px] h-[600px] bg-purple-600/5 blur-[140px] rounded-full animate-pulse-slow" style={{ animationDelay: '2s' }} />
        </div>
      ...
      <motion.div 
        style={{ opacity, scale }}
        className="relative z-20 max-w-[1400px] w-full pt-32 flex flex-col items-center text-center px-6 mb-40"
      >
        {/* Elite Badge */}
        <motion.div
        ...
        {/* Headline System */}
        <div className="mb-24">
          <h1 className="text-6xl md:text-8xl lg:text-[11.5rem] font-bold tracking-tighter text-white leading-[0.75] mb-12 flex flex-wrap justify-center drop-shadow-[0_0_60px_rgba(255,255,255,0.08)]">
        ...
        >
          <p className="text-xl md:text-3xl text-white/40 font-medium max-w-4xl leading-[1.4] balance-text tracking-tight px-4">
            Integral Studio is the dedicated SaaS and product division of Integral Group—designing, developing, and scaling modern software systems, AI tools, and operational platforms.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-10">
            <Magnetic>
              <Button size="lg" className="rounded-full px-20 h-24 text-xs font-bold uppercase tracking-[0.4em] bg-white text-black hover:bg-white/90 hover:scale-105 transition-all duration-700 shadow-[0_20px_80px_rgba(255,255,255,0.15)]">
                Explore Products
              </Button>
            </Magnetic>
            <Magnetic>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[300px] bg-gradient-to-t from-black to-transparent z-30 pointer-events-none" />
    </section>
  );
}
